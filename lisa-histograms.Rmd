...
Now every state (represented as a row in the `population` data frame) has not only it's population (in the `CENSUS2010POP` column) associated to it but also the information which bucket it belongs to for the different styles.
