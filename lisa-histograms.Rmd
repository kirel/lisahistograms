...
Next I calculated some descriptive statistics to help me with the task of cutting the range of population sizes into the different intervals needed for the QGIS styling modes described in Lisa's article. I then computed the breaks of the intervals and the actual intervals.
...
Fortunately the `states` data frame had a field called `region` that closely matched the `name` field of our `population` data frame. Thus by added another column with the right string transformation enabled me to `merge` (or you might be more familiar with the word _join_ for this kind of operation) the two data frames so that I could later color the choropleth's.
